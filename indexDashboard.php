<?php include 'View/BackOffice/pages/event.php'; ?>
<!DOCTYPE html>
<html lang="en">
<!-- [Head] start -->
...
<head>
  ...
  <!-- [Favicon] icon -->
  <link rel="icon" href="Extra/ExtraBack/assets/images/favicon.svg" type="image/x-icon"> <!-- [Google Font] Family -->
<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Public+Sans:wght@300;400;500;600;700&display=swap" id="main-font-link">
<!-- [Tabler Icons] https://tablericons.com -->
<link rel="stylesheet" href="Extra/ExtraBack/assets/fonts/tabler-icons.min.css" >
<!-- [Feather Icons] https://feathericons.com -->
<link rel="stylesheet" href="Extra/ExtraBack/assets/fonts/feather.css" >
<!-- [Font Awesome Icons] https://fontawesome.com/icons -->
<link rel="stylesheet" href="Extra/ExtraBack/assets/fonts/fontawesome.css" >
<!-- [Material Icons] https://fonts.google.com/icons -->
<link rel="stylesheet" href="Extra/ExtraBack/assets/fonts/material.css" >
<!-- [Template CSS Files] -->
<link rel="stylesheet" href="Extra/ExtraBack/assets/css/style.css" id="main-style-link" >
<link rel="stylesheet" href="Extra/ExtraBack/assets/css/style-preset.css" >
  ...
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="../dashboard/index.html" class="b-brand text-primary">
        ...
        <img src="Extra/ExtraBack/assets/images/logo-dark.svg" class="img-fluid logo-lg" alt="logo">
      </a>
    </div>
    <div class="navbar-content">
      ...
      <div class="card text-center">
        <div class="card-body">
          <img src="Extra/ExtraBack/assets/images/img-navbar-card.png" alt="images" class="img-fluid mb-2">
        ...
        <div class="dropdown-header px-0 text-wrap header-notification-scroll position-relative" style="max-height: calc(100vh - 215px)">
          <div class="list-group list-group-flush w-100">
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="Extra/ExtraBack/assets/images/user/avatar-2.jpg" alt="user-image" class="user-avtar">
                </div>
            ...
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="Extra/ExtraBack/assets/images/user/avatar-1.jpg" alt="user-image" class="user-avtar">
                </div>
                <div class="flex-grow-1 ms-1">
            ...
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="Extra/ExtraBack/assets/images/user/avatar-3.jpg" alt="user-image" class="user-avtar">
                </div>
                <div class="flex-grow-1 ms-1">
            ...
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="Extra/ExtraBack/assets/images/user/avatar-4.jpg" alt="user-image" class="user-avtar">
                </div>
                <div class="flex-grow-1 ms-1">
      ...
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
        <div class="dropdown-header">
          <div class="d-flex mb-1">
            <div class="flex-shrink-0">
              <img src="Extra/ExtraBack/assets/images/user/avatar-2.jpg" alt="user-image" class="user-avtar wid-35">
            </div>
...
<!-- [ Header ] end -->
  ...
  <script src="Extra/ExtraBack/assets/js/plugins/apexcharts.min.js"></script>
  <script src="Extra/ExtraBack/assets/js/pages/dashboard-default.js"></script>
  <!-- [Page Specific JS] end -->
  <!-- Required Js -->
  <script src="Extra/ExtraBack/assets/js/plugins/popper.min.js"></script>
  <script src="Extra/ExtraBack/assets/js/plugins/simplebar.min.js"></script>
  <script src="Extra/ExtraBack/assets/js/plugins/bootstrap.min.js"></script>
