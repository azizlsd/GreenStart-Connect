      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              <form class="validate-me" id="validate-me" data-validate method="POST" action="event.html"
                enctype="multipart/form-data">
                <div class="form-group">
                  <label class="form-label">Host</label>
                  <input type="text" name="host_event" class="form-control" placeholder="Nom de l'organisateur"
                    required>
                </div>

                <div class="form-group">
                  <label class="form-label">Titre de l'évènement</label>
                  <input type="text" name="titre_event" class="form-control" placeholder="Titre de l'évènement"
                    required>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="max_participants" class="form-control" id="example-steps" step="1"
                    value="50">
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                    <input name="image" id="file" type="file" class="form-control" data-bouncer-target="#file-error-msg"
                      required>
                    ...
                    <?php if (!empty($events)): ?>
                      <?php foreach ($events as $event): ?>
                        <tr>
                          ...
                          <td>
                            <?= htmlspecialchars($event['host_event']) ?>
                          </td>
                          <td>
                            <?= htmlspecialchars($event['titre_event']) ?>
                          </td>
                          <td>
                            <?= htmlspecialchars(substr($event['description_event'], 0, 50)) ?>...
                          </td>
                          <td>
                          ...
                          <td>
                            <?= htmlspecialchars($event['localisation']) ?>
                          </td>
                          <td>
