...
require_once '../../../Config/config.php';  // Si config.php est dans le répertoire parent
      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
                <form class="validate-me" id="validate-me" data-validate method="POST" action="event.html" enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="form-label">Host</label>
                        <input type="text" name="host_event" class="form-control" placeholder="Nom de l'organisateur" required>
                    </div>
                  
                    <div class="form-group">
                        <label class="form-label">Titre de l'évènement</label>
                        <input type="text" name="titre_event" class="form-control" placeholder="Titre de l'évènement" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <textarea name="description_event" class="form-control" aria-label="With textarea"></textarea>
                        </div>
                    </div>
                  
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3 col-sm-12 text-lg-end">Période de l'évènement</label>
                        <div class="col-lg-4 col-md-9 col-sm-12">
                          <div class="input-daterange input-group" id="pc-datepicker-5">
                            <input type="datetime-local" class="form-control text-left" name="date_debut" required>
                            <span class="input-group-text">à</span>
                            <input type="datetime-local" class="form-control text-end" name="date_fin" required>
                          </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="localisation" class="form-control" placeholder="Lieu" required>
                    </div>
                  
                    <div class="form-group">
                        <label class="form-label" for="example-steps">Nombre Maximal De Participants</label>
                        <input type="number" name="max_participants" class="form-control" id="example-steps" step="1" value="50">
                    </div>
                  
                    <div class="form-group row">
                      <label class="col-lg-4 col-form-label text-lg-end">Image</label>
                      <div class="col-lg-6">
                        <input name="image" id="file" type="file" class="form-control" data-bouncer-target="#file-error-msg" required>
        ...
        <?php if (!empty($events)): ?>
            <?php foreach ($events as $event): ?>
                <tr>
                    ...
                    <td><?= htmlspecialchars($event['host_event']) ?></td>
                    ...
                    <td><?= date('d/m/Y H:i', strtotime($event['date_creation'])) ?></td>
                </tr>
            <?php endforeach; ?>
        <?php else: ?>
            <tr>
