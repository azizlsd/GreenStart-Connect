...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  // Vérification mot de passe (optionnel)
  if (strlen($mot_de_passe) < 6) {
    $errors[] = "Le mot de passe doit contenir au moins 6 caractères.";
  }

  if (empty($errors)) {
    // Inclure le fichier qui contient la fonction create
    $client = new Client();
              ...
              <script>
                document.querySelector('form').addEventListener('submit', function (e) {
                  ...
                  if (!regex.test(email)) {
                    ...
                    alert("❌ Adresse email invalide ! Elle doit contenir un '@' et un domaine. Exemple : exemple@mail.com");
                  }
                });
              </script>
              <?php if (!empty($errors)): ?>
              ...
              <div class="pct-content">
                <div class="theme-color themepreset-color theme-layout">
                  <a href="#!" class="active" onclick="layout_change('light')" data-value="false"><span><img
                        src="/GreenStart-Connect-main/GreenStartConnect/View/BackOffice/assets/images/customization/default.svg"
                        alt="img"></span><span>Light</span></a>
                  <a href="#!" class="" onclick="layout_change('dark')" data-value="true"><span><img
                        src="/GreenStart-Connect-main/GreenStartConnect/View/BackOffice/assets/images/customization/dark.svg"
              ...
              <div class="pct-content">
                <div class="theme-color preset-color">
                  <a href="#!" class="active" data-value="preset-1"><span><img
                        src="/GreenStart-Connect-main/GreenStartConnect/View/BackOffice/assets/images/customization/theme-color.svg"
              ...
              <div class="pct-content">
                <div class="theme-color themepreset-color boxwidthpreset theme-container">
                  ...
                  <a href="#!" class="" onclick="change_box_container('true')" data-value="true"><span><img
                        src="/GreenStart-Connect-main/GreenStartConnect/View/BackOffice/assets/images/customization/container.svg"
