          ...
          <li class="dropdown pc-h-item header-user-profile">
            <a class="pc-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button"
              ...
              <img src="/GreenStart-Connect-main/GreenStartConnect/View/BackOffice/assets/images/user/avatar-2.jpg"
                alt="user-image" class="user-avtar">
              <span>
                <?= htmlspecialchars($_SESSION['client']['prenom'] ?? 'Invité') ?>
              </span>
            </a>
          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <div class="page-header-title">
                <h5 class="m-b-10">Liste des utilisateur</h5>
                <form method="GET" action="index.php" class="d-flex align-items-center gap-2 mb-3 mt-3">
