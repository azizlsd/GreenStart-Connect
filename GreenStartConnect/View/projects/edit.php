        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="index.php?controller=project&action=edit&id=<?php echo $project['id']; ?>" method="POST">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="budget" name="budget" step="0.01" value="<?php echo $project['budget']; ?>" required>
                        </div>
                    ...
                    <?php else: ?>
                        <div class="alert alert-danger">
                            Projet non trouvé.
                            <a href="index.php?controller=project&action=index" class="btn btn-secondary">Retour à la liste</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
