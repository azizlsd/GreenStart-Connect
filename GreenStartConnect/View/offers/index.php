        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="index.php?controller=offer&action=create" class="btn btn-success">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-<?php echo $offer['status'] === 'Active' ? 'success' : 'warning'; ?>">
                                            <?php echo htmlspecialchars($offer['status']); ?>
                                        </span>
                                    </td>
                                    <td><?php echo date('d/m/Y', strtotime($offer['created_at'])); ?></td>
                                    <td>
                                        <a href="index.php?controller=offer&action=view&id=<?php echo $offer['id']; ?>" class="btn btn-info btn-sm">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="index.php?controller=offer&action=edit&id=<?php echo $offer['id']; ?>" class="btn btn-primary btn-sm">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="index.php?controller=offer&action=delete&id=<?php echo $offer['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette offre ?')">
