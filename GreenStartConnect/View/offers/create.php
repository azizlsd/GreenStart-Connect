        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Nouvelle Offre</h5>
                </div>
                <div class="card-body">
                    <form id="offerForm" action="index.php?controller=offer&action=create" method="POST" onsubmit="return validateForm()">
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="index.php?controller=offer&action=index" class="btn btn-secondary">Retour</a>
...
function validateForm() {
    ...
    if (requirements.value.trim().length < 10) {
        alert('Les prérequis doivent contenir au moins 10 caractères');
        requirements.focus();
        return false;
    }
    ...
    if (location.value.trim().length < 3) {
        alert('La localisation doit contenir au moins 3 caractères');
        location.focus();
        return false;
    }
    ...
    if (confirm('Êtes-vous sûr de vouloir créer cette offre ?')) {
        return true;
    }
    return false;
}
