        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h3 class="card-title mb-0">Envoyer une réclamation</h3>
                </div>
                <div class="card-body">
                    <?php if (isset($success) && $success): ?>
                        <div class="alert alert-success">Réclamation envoyée avec succès !</div>
                    <?php elseif (isset($success)): ?>
                        <div class="alert alert-danger">Erreur lors de l'envoi de la réclamation.</div>
                    <?php endif; ?>
                    <form action="index.php?controller=reclamation&action=send" method="POST">
                        <div class="mb-3">
                        ...
                        <button type="submit" disabled class="btn btn-primary">Envoyer</button>
                    </form>
                </div>
            </div>
        </div>
