                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card mb-4">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Balance Totale</h5>
                                    <h2 class="display-4"><?php echo number_format($totalBudget, 2, ',', ' '); ?> €</h2>
                                    <a href="index.php?controller=balance&action=history" class="btn btn-info mt-3">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    <form action="index.php?controller=balance&action=transfer" method="POST" class="needs-validation" novalidate>
                                        <div class="mb-3">
                                            <label for="rib" class="form-label">RIB (23 chiffres)</label>
                                            <input type="text" class="form-control" id="rib" name="rib" 
                                                   pattern="\d{23}" maxlength="23" required
                                                   placeholder="Entrez les 23 chiffres du RIB">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="description" name="description" 
                                                      rows="3" required
                                                      placeholder="Décrivez la raison du transfert"></textarea>
                                            <div class="invalid-feedback">
