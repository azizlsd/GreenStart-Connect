        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Détails de la Postulation</h3>
                </div>
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <h5>Informations personnelles</h5>
                            <p><strong>Nom :</strong> <?php echo htmlspecialchars($postulation['nom']); ?></p>
                            <p><strong>Prénom :</strong> <?php echo htmlspecialchars($postulation['prenom']); ?></p>
                        </div>
                        <div class="col-md-6">
                            <h5>Informations du projet</h5>
                            <p><strong>Projet :</strong> <?php echo htmlspecialchars($postulation['project_title']); ?></p>
                            <p><strong>Date de création :</strong> <?php echo date('d/m/Y', strtotime($postulation['created_at'])); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="p-3 bg-light rounded">
                            <?php echo nl2br(htmlspecialchars($postulation['feedback'])); ?>
                        </div>
                    </div>

                    <div class="d-flex justify-content-between">
                        <a href="index.php?controller=postulation&action=index" class="btn btn-secondary">
                            <i class="fas fa-arrow-left"></i> Retour à la liste
                        </a>
                        <div>
                            <a href="index.php?controller=postulation&action=edit&id=<?php echo $postulation['id']; ?>" 
                               class="btn btn-primary">
                                <i class="fas fa-edit"></i> Modifier
                            </a>
                            <a href="index.php?controller=postulation&action=delete&id=<?php echo $postulation['id']; ?>" 
                               class="btn btn-danger"
                               onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette postulation ?')">
