        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Modifier la Postulation</h3>
                </div>
                <div class="card-body">
                    <form action="index.php?controller=postulation&action=edit&id=<?php echo $postulation['id']; ?>" method="POST">
                        <div class="mb-3">
                            <label for="nom" class="form-label">Nom</label>
                            <input type="text" class="form-control" id="nom" name="nom" 
                                   value="<?php echo htmlspecialchars($postulation['nom']); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="prenom" class="form-label">Prénom</label>
                            <input type="text" class="form-control" id="prenom" name="prenom" 
                                   value="<?php echo htmlspecialchars($postulation['prenom']); ?>" required>
                        </div>
                            ...
                            <select class="form-select" id="project_id" name="project_id" required>
                                ...
                                <?php foreach ($projects as $project): ?>
                                    <option value="<?php echo $project['id']; ?>" 
                                            <?php echo $project['id'] == $postulation['project_id'] ? 'selected' : ''; ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="feedback" name="feedback" rows="4" required><?php 
                                echo htmlspecialchars($postulation['feedback']); 
                            ?></textarea>
                        </div>
