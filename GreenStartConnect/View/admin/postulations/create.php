        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                <div class="card-header bg-success text-white">
                    <h3 class="card-title mb-0">Nouvelle Postulation</h3>
                </div>
                <div class="card-body">
                    <form id="postulationForm" action="index.php?controller=postulation&action=create" method="POST">
                        <div class="mb-3">
...
document.getElementById('postulationForm').addEventListener('submit', function(e) {
    ...
    if (!project.value) {
        messages.push('Veuillez sélectionner un projet.');
        valid = false;
    }
    if (feedback.value.trim().length < 5) {
        messages.push('Le feedback doit contenir au moins 5 caractères.');
        valid = false;
    }
    if (!valid) {
        e.preventDefault();
