        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="freelancer.html" class="nav-item nav-link active">Freelancer</a>
                ...
                <a href="index.php?action=logout" class="btn btn-primary py-2 px-4 ms-3">se déconnéter</a>
            </div>
        </nav>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Freelancer</h1>
                    <a href="" class="h5 text-white">Accueil</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Freelancer</a>
                </div>
            </div>
        </div>
    </div>
