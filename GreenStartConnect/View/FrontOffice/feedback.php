...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
            <h5 class="fw-bold text-primary text-uppercase">Customer Feedback</h5>
            <h1 class="mb-0">What Our Clients Say About Our Services</h1>
        </div>
        <div class="row g-5">
            <div class="col-lg-6"id="form-feedback-card" style="display: none;">
                <div class="bg-light p-5 rounded">
                    <h3 class="mb-4">Share Your Experience</h3>
                    <form id="feedback-form">
                        <div class="form-group mb-4">
                            <label for="name" class="form-label">Your Name</label>
                            <h3 id="name" name="name"><?= htmlspecialchars($_SESSION['client']['nom'] ?? '') ?> <?= htmlspecialchars($_SESSION['client']['prenom'] ?? '') ?></h3>
                        ...
                        <button type="submit" class="btn btn-primary py-2 px-4">Submit Feedback</button>
                    </form>
                </div>
            </div>
            <div class="col-lg-6" id="feedback-carousel-display">
                <div id="feedbackDisplay" class="feedback-carousel">
                    <!-- Les feedbacks seront chargés ici dynamiquement -->
                    <h2 class="text-center mb-4">What People Are Saying</h2>
                    <div class="row" id="feedback-section"></div>
                </div>
            </div>
        </div>
    </div>
